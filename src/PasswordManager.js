...
function    usePassword(pw, scene, player){
	//Set player progress
...
function  generatePassword(scene, player){
	let pass = '';
	let upass = '';
	...
	}else if(getNPC("NicoleD").state != 9){
...
function  getNumFromSeed(num, seed){
	let gen = num + seed;  
