...
function spawnProjectile(x, y, cst, st, name, rep, dmg, size, time, sprite){
...
function watchPlayer(go, down, up, right, left){
	let anim = "nothing";
	if(go.startY - 50 > go.y){
		//npc below
		go.setVelocityY(256);
...
function setCameras(){
	...
	//have camera follow player around
	this.scene.cameras.add( this.scene.game.renderer.width-this.scene.cmd2.displayWidth, 0, this.scene.cmd2.displayWidth, this.scene.game.renderer.height, false, "cmd2");
...
function setObjects(){
	...
	this.createEnemies(561, CST.SPRITE.VLAD, 8, CST.SPRITE.NERD1,  0, "nerd1down", 5, 1, 2);
	this.createEnemies(565, CST.SPRITE.VLAD, 8, CST.SPRITE.NERD1,  0, "nerd1up", 5, 1, 2);
	this.createEnemies(569, CST.SPRITE.VLAD, 8, CST.SPRITE.NERD1,  0, "nerd1right", 5, 1, 2);
	this.createEnemies(573, CST.SPRITE.VLAD, 8, CST.SPRITE.NERD1,  0, "nerd1left", 5, 1, 2);
	this.createEnemies(578, CST.SPRITE.VLAD, 8, CST.SPRITE.NERD2,  0, "nerd2down", 5, 1, 2);
	this.createEnemies(589, CST.SPRITE.VLAD, 8, CST.SPRITE.NERD2,  0, "nerd2up", 5, 1, 2);
	this.createEnemies(581, CST.SPRITE.VLAD, 8, CST.SPRITE.NERD2,  0, "nerd2right", 5, 1, 2);
	this.createEnemies(582, CST.SPRITE.VLAD, 8, CST.SPRITE.NERD2,  0, "nerd2left", 5, 1, 2);
...
function createItems(key, frame, name){
...
function createNPCS(key, cst1, frame, cst2, down, up, left, right, name){
...
function createEnemies(key, cst1, frame, cst2, st, name, rep, dmg, size){
